...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Rating.helpfulness'
        db.add_column(u'rates_rating', 'helpfulness',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Rating.knowlegdeable'
        db.add_column(u'rates_rating', 'knowlegdeable',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Rating.helpfulness'
        db.delete_column(u'rates_rating', 'helpfulness')

        # Deleting field 'Rating.knowlegdeable'
        db.delete_column(u'rates_rating', 'knowlegdeable')
    ...
    models = {
        ...
        u'rates.rating': {
            ...
            'helpfulness': ('django.db.models.fields.IntegerField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'knowlegdeable': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
